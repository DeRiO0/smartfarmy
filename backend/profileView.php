                ...
                <header>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <font size="+1"><?php echo isset($_SESSION['Rating'])?$_SESSION['Rating']: "";?></font>
                        </div>
                        <div class="col-sm-3">
                            ...
                            <center>
                                <div class="row uniform">
                                    <div class="3u 12u$(large)">
                                        <a href="/smartfarm/backend/change.php" class="btn btn-danger" style="text-decoration: none;">Change Password</a>
                                    </div>
                                    <div class="3u 12u$(large)">
