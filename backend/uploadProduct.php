		...
		if(in_array($picActualExt, $allowed))
		{
			if($picError === 0)
			{
				...
				if($result)
				{
					...
					$_SESSION['message'] = "उत्पादन प्रतिमा यशस्वीरित्या अपलोड !!!";
					header("Location: market.php");
				}
				else
				{
					//die("bad");
					$_SESSION['message'] = "तुमच्या उत्पादनाची प्रतिमा अपलोड करताना त्रुटी आली! कृपया पुन्हा प्रयत्न करा!";
					header("Location: Login/error.php");
				}
			}
			else
			{
				$_SESSION['message'] = "तुमची उत्पादन प्रतिमा अपलोड करताना त्रुटी आली! कृपया पुन्हा प्रयत्न करा!";
				header("Location: Login/error.php");
			}
		}
		else
