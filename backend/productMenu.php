	...
	<body class>
		...
		<!-- One -->
			<section id="main" class="wrapper style1 align-center" >
				<div class="container">
						<h2><b>स्वागत आहे</b> डिजिटल मार्केटला</h2>
							...
							<div class="col-sm-2">
								<div class="select-wrapper" style="width: auto" >
									<select name="type" id="type" required style="background-color:white;color: black;">
										<option value="all" style="color: black;">सर्वांची यादी करा</option>
										<option value="fruit" style="color: black;">फळ</option>
										<option value="vegetable" style="color: black;"></option>
