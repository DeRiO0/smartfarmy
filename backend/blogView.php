<?php
	...
	{
		$_SESSION['message'] = "या पृष्ठावर प्रवेश करण्यासाठी आपल्याला प्रथम लॉग इन करणे आवश्यक आहे !!!";
...
<html>
	<head>
		<title>स्मार्टफार्मी : Blogs</title>
		<meta charset="utf-8" />
				...
				<div class="inner">
					...
					<div class="row uniform">
						...
						<div class="3u 12u$(small)">
							<a href="blogWrite.php" class="button special fit"><span class="glyphicon glyphicon-pencil"></span>ब्लॉग लिहा</a>
						</div>
					</div>
					<br />
					<?php
